...
const [loading, setloading] = useState(true);
  ...
  function LoadingConsumer() {
    ...
    if (isloading) {
      return (
        <div className="max-w-4xl mx-auto p-10 z_index">
...
return(
    ...
    <div className="mx-auto overflow-hidden z_index">
        ...
        <div className=" flex text-sm z_index justify-start lg:justify-center lg:items-center flex w-72 mx-auto scroll-wi rounded-lg scrollb sm:scrollbar-thumb-transparent  scroll-p-0 scroll-smooth scrollbar scrollbar-thumb-blue-300  scrollbar-thin scrollbar-track-white my-2">
            ...
            <p onClick={() => handleToggle(2)} className={`border-t-1 sm:translate-x-4 border border-b-1 border-gray-400  cursor-pointer whitespace-nowrap py-1 px-5 border border-r-1 sm:border-l-0 hover:border-l-0 sm:rounded-tr-lg sm:rounded-br-lg rounded-tl-0 rounded-bl-0 ${toggle === 2 ? 'color' : 'none'}`}>
                Published Articles
            </p>
            <p onClick={() => handleToggle(3)}  className={`border-t-1 sm:translate-x-2 border border-b-1 border-gray-400 cursor-pointer whitespace-nowrap py-1 px-5 border border-r-1 border-l-0 hover:border-l-0 sm:rounded-tr-lg sm:rounded-br-lg rounded-tl-0 rounded-bl-0 ${toggle === 3 ? 'color' : 'none'}`}>
                Scheduled Articles
            </p>
